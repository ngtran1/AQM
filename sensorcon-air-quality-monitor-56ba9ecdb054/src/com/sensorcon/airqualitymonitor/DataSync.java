	...
	protected Void doInBackground(Void... params) {
		...
		DroneEventHandler myHandler = new DroneEventHandler() {
			...
			public void parseEvent(DroneEventObject arg0) {
				Log.d("NguyenDebug", "arg0 event " + arg0.getSource());
				// Program it in order...
				...
				if (arg0.matches(droneEventType.UART_READ)) {
					...
					myDBHandler.open();
					long id = myDBHandler.addData(dateTime, coData, co2Data, tempData, humidityData, presureData); //Nguyen: code to add data to database
